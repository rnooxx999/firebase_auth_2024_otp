...
import 'package:firebase_auth_2024/data/firebase_otp.dart';
import 'package:firebase_auth_2024/domin/shared/components/components.dart';
import 'package:firebase_auth_2024/featuers/utilites/enum.dart';
              ...
              children: [
                      ...
                      children: [
                        InternationalPhoneNumberInput(
                          ...
                          onSaved: (PhoneNumber number) {
                            print("number : $number");
                            //viewModel.add(PhoneSendNumberEvent(phoneNumber: number));
                          },
                        ),
                        Positioned(
                          left: 90,
                ...
                FadeInDown(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      viewModel.add(PhoneSendNumberEvent(phoneNumber: numberPhone ,context: context));
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Verificatoin(viewModel)));
                ...
                FadeInDown(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('Go Back To The Options',
                        style: TextStyle(color: Colors.grey.shade700),),
                      SizedBox(width: 5,),
                      InkWell(
                        onTap: () {
                          navigateAndFinish(context, routeHomeNAvigatorScreen);
                        },
